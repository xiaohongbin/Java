...
import java.io.File;
import java.io.FileOutputStream;//从文件系统中的某个文件中获得输入字节
import java.io.OutputStreamWriter;//用来按照指定的字符集编码将字符流转换成字节流
...
public class Logger {
	...
	public static void Output1(Logger.LogTypeName logTypeName, String logMessage) {
