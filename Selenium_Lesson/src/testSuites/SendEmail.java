...
public class SendEmail {
	...
	public static void main(String[] args) {
		...
		Session session = Session.getDefaultInstance(props, new javax.mail.Authenticator() {
			...
			return new PasswordAuthentication("784578607@qq.com", "sylreneupbchbbab");
		...
		try {
			...
			// 设置发件人邮箱地址
			message.setFrom(new InternetAddress("784578607@qq.com"));
 
			// 设置收件人邮箱地址
			message.setRecipients(Message.RecipientType.TO,InternetAddress.parse("xiaohongbin@tech.youyuan.com"));
